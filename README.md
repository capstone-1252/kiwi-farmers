...
These steps are to be followed whenever you intend to contribute this GitHub repository;
    ...
    commit.
        - If a teammate has committed something to the repository during the duration of you working, remember to Pull the repository again to ensure there are no merge conflicts
